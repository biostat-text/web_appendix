...
書籍「医療統計学入門 ―医学・薬学研究のためのエビデンス構築―」のサンプルRコード、データ、問題略解などをここに配置しています。


[Rのダウンロード方法](https://htmlpreview.github.io/?https://github.com/biostat-text/web_appendix/blob/main/R_download_guide.html?raw=1)
...
　章末問題:
　[略解](https://github.com/biostat-text/web_appendix/blob/main/Ch1_Problems_solution.pdf)
...
　章末問題:
　[略解](https://github.com/biostat-text/web_appendix/blob/main/Ch2_Problems_solution.pdf)
...
　章末問題:
　[略解](https://github.com/biostat-text/web_appendix/blob/main/Ch3_Problems_solution.pdf)
...
　章末問題:
　[略解](https://github.com/biostat-text/web_appendix/blob/main/Ch4_Problems_solution.pdf)
...
　章末問題: 
  [略解](https://github.com/biostat-text/web_appendix/blob/main/Ch5_Problems_solution.pdf)
  [Rコード](https://github.com/biostat-text/web_appendix/blob/main/Ch5_Problems_R.txt)
  [実行結果](https://github.com/biostat-text/web_appendix/blob/main/Ch5_Problems_R_output.txt)
...
　章末問題:
  [略解](https://github.com/biostat-text/web_appendix/blob/main/Ch6_Problems_solution.pdf)
  [Rコード](https://github.com/biostat-text/web_appendix/blob/main/Ch6_Problems_R.txt)
...
　章末問題:
　[略解](https://github.com/biostat-text/web_appendix/blob/main/Ch8_Problems_solution.pdf)
　[Rコード](https://github.com/biostat-text/web_appendix/blob/main/Ch8_Problems_R.R) 

### 第9章: 相関と回帰分析
  
　本文:
　[Rコード](https://biostat-text.github.io/web_appendix/Ch09_Rcode.html)
...
　本文:
　[Rコード](https://biostat-text.github.io/web_appendix/Ch10-Rcode.html)
